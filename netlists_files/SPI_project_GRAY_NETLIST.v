...
// Date        : Sun Aug  9 17:09:36 2026
// Host        : LAPTOP-V744TBO4 running 64-bit major release  (build 9200)
// Command     : write_verilog C:/Users/Arwa/Desktop/SPI/SPI.v
// Design      : SPI_Wrapper
...
module SPI_SLAVE
  ...
  LUT6 #(
    ...
    \FSM_gray_cs[2]_i_2 
       (.I0(D),
        ...
        .I5(cs[1]),
        .O(ns[2]));
  (* FSM_ENCODED_STATES = "CHK_CMD:001,WRITE:011,READ_DATA:010,READ_ADD:111,IDLE:000" *) 
  (* KEEP = "yes" *) 
  FDRE #(
    .INIT(1'b0)) 
    \FSM_gray_cs_reg[0] 
  ...
  LUT6 #(
    ...
    MISO_i_1
       (.I0(cs[1]),
        ...
        .I2(cs[2]),
        .I3(cs[0]),
        .I4(\counter_tx_reg_n_0_[3] ),
        .I5(\counter_tx[3]_i_3_n_0 ),
        .O(MISO_i_1_n_0));
  FDRE #(
    .INIT(1'b0)) 
    MISO_reg
  ...
  LUT5 #(
    ...
    \counter_rx[3]_i_1 
       (.I0(cs[2]),
        .I1(cs[0]),
        .I2(\counter_rx[3]_i_3_n_0 ),
        .I3(\counter_rx[3]_i_4_n_0 ),
        .I4(cs[1]),
        .O(counter_rx));
  (* SOFT_HLUTNM = "soft_lutpair1" *) 
  LUT5 #(
  ...
  LUT5 #(
    ...
    mem_reg_i_1
       (.I0(tx_valid_reg[9]),
        ...
        .O(mem_reg));
  LUT6 #(
    .INIT(64'hCFFFFFFFC0880088)) 
    rd_addr_received_i_1
       (.I0(cs[2]),
        .I1(rd_addr_received_i_2_n_0),
        .I2(tx_valid),
        .I3(\counter_rx[3]_i_4_n_0 ),
        .I4(rd_addr_received_i_3_n_0),
  ...
  LUT3 #(
    .INIT(8'h04)) 
    rd_addr_received_i_4
       (.I0(cs[0]),
        .I1(cs[1]),
        .I2(cs[2]),
        .O(rd_addr_received_i_4_n_0));
  FDRE #(
    .INIT(1'b0)) 
